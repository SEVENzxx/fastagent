...
class SalesMemory(Base):
    ...
    memory_type: Mapped[str] = mapped_column(String(20), nullable=False, default="preference", server_default="preference", comment="记忆类型: preference/note/fact")
    key: Mapped[str] = mapped_column(String(100), nullable=False, comment="记忆键: favorite_flavor/budget_range/常用地址")
    value: Mapped[str] = mapped_column(Text, nullable=False, comment="记忆值")
    source: Mapped[str] = mapped_column(String(30), nullable=False, default="ai_deduction", server_default="ai_deduction", comment="来源: customer_message/agent_note/ai_deduction")
